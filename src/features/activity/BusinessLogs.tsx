...
const BusinessLogs = () => {
  const { business, success, error, loading, clearError, fetchLogs } = useLogs()
    ...
    <Container className="edit-business">
      ...
      <div className="head-info">
        <div className="name-desc">
          <div className="name">Business Logs</div>
          <div className="desc">View recent business related activity and updates</div>
        </div>
