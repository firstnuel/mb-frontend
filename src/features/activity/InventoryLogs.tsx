...
const InventoryLogs = () => {
  const { inventory, success, error, loading, clearError, fetchLogs } = useLogs()
    ...
    <Container className="edit-business">
      ...
      <div className="head-info">
        <div className="name-desc">
          <div className="name">Inventory Logs</div>
          <div className="desc">View recent inventory activity and updates</div>
        </div>
